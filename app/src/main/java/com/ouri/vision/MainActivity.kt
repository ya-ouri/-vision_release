...
>>>>>>> e25b3cd95e0692ad5a8ea459bc2f9087d0528ec1
    ...
    private fun processImageProxy(imageProxy: ImageProxy) {
        ...
        fun rotateBitmapIfNeeded(bitmap: Bitmap, imageProxy: ImageProxy, shouldMirror: Boolean): Bitmap {
            ...
            Log.d("MainActivity", "Rotation Degrees: $rotationDegrees, Should Mirror: $shouldMirror")
        ...
        // Передаем параметр shouldMirror в зависимости от используемой камеры
        val correctedBitmap = rotateBitmapIfNeeded(bitmap, imageProxy, !isBackCamera)
...
>>>>>>> e25b3cd95e0692ad5a8ea459bc2f9087d0528ec1
    ...
    private fun applyFilter(filterType: String) {
        if (filterType == "dog") {
            ...
            val blurFilter = GPUImageGaussianBlurFilter(0.6f)
            val contrastFilter = GPUImageContrastFilter(0.3f)
