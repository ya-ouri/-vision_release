...
dependencies {
    ...
    implementation ("androidx.core:core-ktx:1.13.1") // Убедитесь, что версия актуальна
    implementation ("com.google.android.material:material:1.12.0") // Для TabLayout
    implementation ("androidx.viewpager2:viewpager2:1.1.0") // Для ViewPager2
